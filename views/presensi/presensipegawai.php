...
<div class="presensi-form">
    ...
    <?= $form->field($model, 'jam_masuk')->textInput(['value' => $waktu_masuk, 'readonly' => true]) ?>
    ...
    <?= $form->field($model, 'logpresensi_id')->textInput(['value' => $logpresensi_id, 'readonly' => true]) ?>

    <?= $form->field($model, 'latitude')->textInput(['value' => $lat, 'readonly' => true]) ?>

    <?= $form->field($model, 'longitude')->textInput(['value' => $long, 'readonly' => true]) ?>
